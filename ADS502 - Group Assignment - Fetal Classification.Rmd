...
confusionMatrix(fetal_pred, fetal_test$fetal_health)
...
confusionMatrix(fetal_predCart, fetal_test$fetal_health)
...
confusionMatrix(fetal_pred_C5, fetal_test$fetal_health)
